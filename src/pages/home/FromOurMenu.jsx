...
const FromOurMenu = () => {
    ...
    const slicedMenu = menu.slice(0, 6);
  ...
  return (
    <div className='my-10'>
        ...
        <div className='w-fit mx-auto'>
            <Link to={'/menu'}>
                <button className='btn bg-white border-t-transparent border-r-transparent border-l-transparent border-b-3 border-b-black rounded-lg'>View Full Menu</button>
            </Link>
        </div>
    </div>
  )
